...
export function fallbackAnswer(message, reviewedOnly = false) {
  ...
  if (/\b(hello|hi|namaste)\b/.test(text)) return "Namaste. I am Neerja, your Vyavsay guide. Ask me about a workflow, template, challenge, application, pilot, payment, validation, or scale-up.";
